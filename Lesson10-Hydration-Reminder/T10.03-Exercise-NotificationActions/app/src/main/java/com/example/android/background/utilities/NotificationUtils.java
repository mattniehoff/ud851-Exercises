...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 8675309;
    private static final int ACTION_DRINK_ACTION_INTENT_ID = 8675308;
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent drinkWaterPendingIntent = PendingIntent.getService(
                context,
                ACTION_DRINK_ACTION_INTENT_ID,
                drinkWaterIntent,
                PendingIntent.FLAG_UPDATE_CURRENT);
        //      COMPLETE (15) Create an Action for the user to tell us they've had a glass of water
        NotificationCompat.Action drinkWaterReminderAction = new NotificationCompat.Action(R.drawable.ic_cancel_black_24px,
                "Finito!",
